$(() => {
  ...
  $("#btn-login").click(function () {
    ...
    let dataAuthCompany = {
      agent_id: 10,
      avatar:
        "http://localhost:8000/storage/assets/images/uploads/gravatar/gina-dwitasari-10.png",
      company_name: "Gina Company",
              ...
              $("#fetch-message").append(`
                    <div style='margin-bottom: 8px;'>
                        ...
                        <div style='width: 100px; height: auto'>
                            <img
                                src='${
                                  chat.file_url && chat.file_type == "image"
                                    ? chat.file_url
                                    : "#"
                                }'
                                class='${
